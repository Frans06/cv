...
%------- Modus Create --------
  ...
  \entry	
    ...
    {Vest}
    {Financial company democratizing financial opportunities to Latam.\vspace{-1mm}
    \begin{itemize}[label=$•$]
    \addtolength{\itemindent}{-4mm}
    	\item Working on all backend architecture in order to connect all services on trading and banking. 
		\item Working on all the IAC in pulumi and AWS using ECS, Elastic LB, RDS, Elastic Cache and other transport layer AWS options.
		\item Working on App features in React Native including Authentication with cognito, navigation screens and more.
	\end{itemize}
    } 
...
%------- Modus Create --------
  ...
  \entry	
    ...
    \addtolength{\itemindent}{-4mm}
		...
		\item Working with Cloudflare Workers to deploy serverless code on transportation layers across the globe to give it exceptional performance, reliability, and scale for Pfizer.
		\item Cache optimization for Pfizer pages.
	\end{itemize}
    } 
